...
$CMAKE_ARGS = " -DMNN_SEP_BUILD=OFF -DMNN_BUILD_TRAIN=OFF -DMNN_BUILD_OPENCV=ON -DMNN_IMGCODECS=ON  -DMNN_OPENCL=ON -DMNN_VULKAN=ON  -DMNN_CUDA=ON -DMNN_AVX512=ON -DMNN_LOW_MEMORY=ON -DMNN_BUILD_SHARED_LIBS=ON"
